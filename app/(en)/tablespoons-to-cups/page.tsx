...
import { tablespoonsToCupsEn as copy } from "@/content/en/tablespoons-to-cups";

const PATH = "/tablespoons-to-cups";
const ALT_PATH = "/es/cucharadas-a-tazas";
...
export default function Page() {
  const ldBreadcrumb = breadcrumbSchema([
    ...
    { name: "Tablespoons to cups", path: PATH },
  ]);
  ...
  return (
    <CalculatorPageShell
      ...
      alternateLink={{
        label: "¿Necesitas esta herramienta en español? Ver cucharadas a tazas.",
        href: ALT_PATH,
        hrefLang: "es-419",
      }}
