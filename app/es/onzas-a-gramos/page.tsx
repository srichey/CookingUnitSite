...
import { onzasAGramosEs as copy } from "@/content/es/onzas-a-gramos";

const PATH = "/es/onzas-a-gramos";
const ALT_PATH = "/ounces-to-grams";
...
export default function Page() {
  ...
  return (
    <CalculatorPageShell
      ...
      alternateLink={{
        label: "Need this in English? Open the ounces to grams converter.",
        href: ALT_PATH,
        hrefLang: "en-US",
      }}
