...
import { mililitrosATazasEs as copy } from "@/content/es/mililitros-a-tazas";

const PATH = "/es/mililitros-a-tazas";
const ALT_PATH = "/ml-to-cups";
...
export default function Page() {
  const ldBreadcrumb = breadcrumbSchema([
    ...
    { name: "Mililitros a tazas", path: PATH },
  ]);
  ...
  return (
    <CalculatorPageShell
      ...
      alternateLink={{
        label: "Need this in English? Open the milliliters to cups converter.",
        href: ALT_PATH,
        hrefLang: "en-US",
      }}
